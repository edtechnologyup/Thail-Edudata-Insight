        ...
        <>
          <div className="flex flex-col">
            {items.slice(0, 10).map((item, index) => {
              ...
              return (
                ...
                >
                  <span
                    className="w-7 shrink-0 text-center font-kanit text-[1.5rem] font-bold"
                    style={{ color: "#1a3a2a", opacity }}
                  >
                    {index + 1}
                  </span>
                  ...
                  <div className="shrink-0 text-right">
                    <span className="font-kanit text-body-md font-bold" style={{ color: "#00695c" }}>
          ...
          <div className="mt-5 flex justify-center">
            <Link
              ...
              className="inline-flex items-center gap-1.5 rounded-2xl border-2 px-8 py-2.5 font-sarabun text-label font-bold transition-all hover:opacity-80"
